...
/***/ function(module, exports, __webpack_require__) {
	...
	var _testHook = __webpack_require__(3);
	  ...
	  _createClass(Validator, [{
	    ...
	    value: function _validateField(field) {
	      ...
	      var _loop = function _loop(i, ruleLength) {
	        ...
	        if (typeof _testHook2.default[method] === 'function') {
	          if (!_testHook2.default[method].apply(_this, [field, param])) {
	            isSuccess = false;
	          }
	        }
	
	        // 错误信息域
	        _this.errors[field.name] = {
	          el: field.el,
	          name: field.name,
	          rule: method
	        };
	        ...
	        if (!isSuccess) {
	          // 错误提示
	          _this.errors[field.name].message = function message() {
	        ...
	        errorObj = _this.errors[field.name];
	      };
	    ...
	    value: function _updateField(field) {
	      ...
	      if (el) {
	        ...
	        field.value = (0, _util.attributeValue)(el, 'value');
	        field.checked = (0, _util.attributeValue)(el, 'checked');
	      } else {
	        // 动态删除表单域之后清空对象值
	        (0, _util.initField)(field);
	      }
